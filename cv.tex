...
\section{Publications} 
                {\sl First Authored}
                \begin{benumerate}{4}
                    \item $^{\star}$\textbf{Lustig-Yaeger, J.}, Meadows, V. S., \& Lincowski, A. P. (2019, $^{\star}$\textit{submitted}). \href{}{``Mirages of a cosmic shoreline: Venus-like clouds as a statistical false positive for exoplanet atmospheric erosion''}. \textit{The Astrophysical Journal Letters}. 
