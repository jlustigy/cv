...
\section{Honors, Awards, \& Funded Proposals}
                 \begin{itemize}  \itemsep -1pt %reduce space between items
                    ...
                    \item \textbf{NASA Exoplanet Research Program PI:} \href{https://nspires.nasaprs.com/external/viewrepositorydocument/cmdocumentid=897851/solicitationId=%7B0D14DDFD-D4F8-3D3C-0E3C-5C48EA50B512%7D/viewSolicitationDocument=1/XRP22%20Abstracts.pdf}{``Venus as an Exoplanet: Constructing a Venus Transmission Spectrum from Venus Express Solar Occultation Measurements''} (2022)
...
\section{Technical \\Skills} 
                \begin{itemize}  \itemsep -1pt %reduce space between items
                    ...
                    \item Writing and typesetting with \LaTeX~ and Overleaf
                    \item Extensive experience with MS Office Suite \\
                \end{itemize}

\section{Community Service} 
                \begin{itemize}  \itemsep -1pt %reduce space between items
                    \item Science Organizing Committee: \href{https://www.stsci.edu/contents/events/stsci/2023/may/planetary-systems-and-the-origins-of-life-in-the-era-of-jwst}{STScI 2023 Spring Symposium} \hfill (Aug 2022 -- present) 
                    \item Section Co-Editor: ``Handbook of Exoplanets, Second Edition'' \hfill (Mar 2022 -- present) 
                    \item Participating Member and Task Co-Lead: \href{https://doi.org/10.48550/arXiv.2112.04517}{ExoPAG SAG 22} \hfill (Oct 2020 -- Dec 2021)
                    \item Reviewer for AAS Journals, MNRAS, Nature Astronomy \hfill (2017 - present)\\
                \end{itemize}

\section{Publications} 
                {\sl First Authored}
                \begin{benumerate}{7}
                    \item \textbf{Lustig-Yaeger, J.} \& Fu, G., May, E. M., Ceballos, K. N., Moran, S. E., Peacock, S., Stevenson, K. B., Kirk, J., L\'opez-Morales, M., MacDonald, R. J., Mayorga, L. C., Sing, D. K., et al. (2023, \textit{submitted to Nature Astronomy}). \href{https://ui.adsabs.harvard.edu/abs/2023arXiv230104191L/abstract}{``A JWST transmission spectrum of a nearby Earth-sized exoplanet''}. \textit{arXiv preprint arXiv:2301.04191.}
                ...
                {\sl Co-Authored}
                \begin{benumerate}{26}
                    %\item $^{\star}$Meadows, V. S., Lincowski, A. P., \& \textbf{Lustig-Yaeger, J.} (2022, $^{\star}$\textit{in prep}). \href{}{``The Feasibility of Detecting Biosignatures in the TRAPPIST-1 Planetary System with JWST''}. % \textit{AAS Journals}.
                    \item Ahrer, E. M., Stevenson, K. B., Mansfield, M. et al. (2023). \href{https://doi.org/10.1038/s41586-022-05590-4}{``Early Release Science of the exoplanet WASP-39b with JWST NIRCam''}. \textit{Nature} 614, 653-658. 
                    \item Rustamkulov, Z., Sing, D. K., Mukherjee, S. et al. (2023). \href{https://doi.org/10.1038/s41586-022-05677-y}{``Early Release Science of the exoplanet WASP-39b with JWST NIRSpec PRISM''}. \textit{Nature} 614, 659-663. 
                    \item JWST Transiting Exoplanet Community Early Release Science Team (2023). \href{https://doi.org/10.1038/s41586-022-05269-w}{``Identification of carbon dioxide in an exoplanet atmosphere''}. \textit{Nature} 614, 649-652. 
                    \item Limbach, M. A., Vanderburg, A., Stevenson, K. B., Blouin, S., Morley, C., \textbf{Lustig-Yaeger, J.}, Soares-Furtado, M. and Janson, M., (2022). \href{https://doi.org/10.1093/mnras/stac2823}{``A new method for finding nearby white dwarfs exoplanets and detecting biosignatures''}. \textit{Monthly Notices of the Royal Astronomical Society}, 517(2), pp.2622-2638.
                    \item Mandell, A. M., \textbf{Lustig-Yaeger, J.}, Stevenson, K., \& Staguhn, J. (2022). \href{https://doi.org/10.3847/1538-3881/ac83a5}{``MIRECLE: Science Yield for a Mid-IR Explorer-Class Mission to Study Non-Transiting Rocky Planets Orbiting the Nearest M-Stars Using Planetary Infrared Excess''}. \textit{The Astronomical Journal}, 164, 176. 
                    \item Mandt, K., Luspay-Kuti, A., \textbf{Lustig-Yaeger, J.}, Felton, R., \& Domagal-Goldman, S. (2022). \href{https://iopscience.iop.org/article/10.3847/1538-4357/ac59bb}{``TRAPPIST-1h as an Exo-Titan. I. The Role of Assumptions about Atmospheric Parameters in Understanding an Exoplanet Atmosphere''}. \textit{The Astrophysical Journal}, 930(1), 73. 
                    \item Wood, B. E., Hess, P., \textbf{Lustig-Yaeger, J.}, Gallagher, B., Korwan, D., Rich, N., et al. (2022). \href{https://doi.org/10.1029/2021GL096302}{``Parker Solar Probe imaging of the night side of Venus''}. \textit{Geophysical Research Letters}, 49(3), e2021GL096302. 
                    \item Hinkel, N. R., Pepper, J., Stark, C. C., Burt, J. A., Ciardi, D. R., Hardegree-Ullman, K. K., \textbf{Lustig-Yaeger, J.}, Kopparapu, R., Mishra, L., Molaverdikhani, K., Pascucci, I., et al. (2021). \href{https://doi.org/10.48550/arXiv.2112.04517}{``Final Report for SAG 22: A Target Star Archive for Exoplanet Science''}. \textit{arXiv preprint arXiv}:2112.04517.
...
\section{Presentations} 
                {\sl Invited Talks}
                \begin{benumerate}{5}
                    \item \textbf{Lustig-Yaeger, J.} (2022). ``Rocky Exoplanet Characterization on the Path Towards Habitability and Biosignatures''. University of Maryland Planetary Astronomy Lunch Seminar Series, MD, Feb. 21
 ...
 \section{Public Talks}
                \begin{itemize}  
                    \item ``How Astronomers are Searching for Life on Planets Outside of the Solar System'' Western Institute for Lifelong Learning, Silver City, NM. November 10, 2022. 
...
\section{Press}
                \begin{itemize}  
                    \item Johns Hopkins Applied Physics Lab, Laurel, MD. (2023, January 11). \href{https://www.jhuapl.edu/news/news-releases/230111b-nasa-webb-and-apl-identify-telescope-first-rocky-exoplanet}{``NASA's Webb Identifies Its First Exoplanet — And It's the Size of Earth''} [Press release].
