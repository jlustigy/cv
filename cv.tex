...
\section{Publications} 
                {\sl First Authored}
                \begin{benumerate}{4}
                    \item $^{\star}$\textbf{Lustig-Yaeger, J.}, Meadows, V. S., \& Lincowski, A. P. (2019, $^{\star}$\textit{in press}). \href{https://ui.adsabs.harvard.edu/abs/2019arXiv191109132L/abstract}{``A Mirage of the cosmic shoreline: Venus-like clouds as a statistical false positive for exoplanet atmospheric erosion''}. \textit{The Astrophysical Journal Letters}. \textit{arxiv preprint arXiv:1911.09132}. 
