...
\section{Publications} 
                ...
                \begin{benumerate}{16}
                    ...
                    \item $^{\star}$Mansfield, M., Schlawin, E., \textbf{Lustig-Yaeger, J.}, et al. (2020, $^{\star}$\textit{accepted}). \href{https://arxiv.org/abs/2010.02197}{``Eigenspectra: A Framework for Identifying Spectra from 3D Eclipse Mapping''}. \textit{Monthly Notices of the Royal Astronomical Society}.
