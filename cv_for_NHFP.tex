...
\section{Education} 
Ph.D. Candidate in Astronomy \& Astrobiology  \hfill (2014 -- Present) \\
...
\section{Research \\Experience} 
                {\sl Graduate Research Assistant}:   \hfill (Sept 2014 -- Present)\\
                Virtual Planetary Laboratory
                    \begin{itemize}  \itemsep -1pt %reduce space between items
                        \item Studied terrestrial exoplanets, their atmospheres, habitability \& biosignatures
                ...
                {\sl Undergraduate \& Post-baccalaureate Researcher}: \hfill          (2012 -- 2014)\\
                University of California, Santa Cruz
                    \begin{itemize}  \itemsep -1pt %reduce space between items
                        \item Studied hot Jupiter \& brown dwarf atmospheres, opacity sources, and atmospheric retrieval 
...
\section{Teaching \\Experience} 
                {\sl Research Mentor}: \hfill (Sept 2016 -- Present)\\
                Department of Astronomy, University of Washington 
                \begin{itemize}  \itemsep -1pt %reduce space between items
                        \item Advised undergraduate students in exoplanet astronomy and astrobiology research\\
                    \end{itemize}
                
                {\sl Teaching Assistant}:   \hfill          (Sept 2014 -- June 2015)\\
                Department of Astronomy, University of Washington 
                    \begin{itemize}  \itemsep -1pt %reduce space between items
                        \item Led two biweekly sections for undergraduate students
                        \item ASTR 101 (Spring 2015; Autumn 2014)
                        \item ASTR 150 (Winter 2015)
                    \end{itemize}  
                
                {\sl Math \& Writing Tutor}:   \hfill          (Sept 2010 -- June 2012)\\
                Learning Support Services, UC Santa Cruz
                \begin{itemize}  \itemsep -1pt %reduce space between items
                        \item Instructed students in college level mathematics and writing as a group and drop-in tutor\\
                    \end{itemize}  
...
\section{List of \\Publications} 
                {\sl ~~~\underline{First Authored}}
                \begin{benumerate}{4}
                    \item $^{\star}$\textbf{Lustig-Yaeger, J.}, Meadows, V. S., \& Lincowski, A. P. (2019, $^{\star}$\textit{in review}). \href{}{``Mirages of a cosmic shoreline: Venus-like clouds as a statistical false positive for exoplanet atmospheric erosion''}. \textit{The Astrophysical Journal Letters}. 
                ...
                \end{benumerate}
                {\sl ~~\underline{Co-Authored}}
                \begin{benumerate}{15}
                    \item $^{\star}$Meadows, V. S., Lincowski, A. P., \& \textbf{Lustig-Yaeger, J.} (2019, $^{\star}$\textit{in prep}). \href{}{``The Feasibility of Detecting Biosignatures in the TRAPPIST-1 Planetary System with JWST''}. % \textit{AAS Journals}.
                    \item $^{\star}$Leung, M., Meadows, V. S., \& \textbf{Lustig-Yaeger, J.} (2019, $^{\star}$\textit{in prep}). \href{}{``High-Resolution Spectral Discriminants of Ocean Loss for M Dwarf Terrestrial Exoplanets''}. %\textit{The Astrophysical Journal}.
                    \item $^{\star}$Mansfield, M., Schlawin, E., \textbf{Lustig-Yaeger, J.}, et al. (2019, $^{\star}$\textit{in prep}). \href{}{``Eigenspectra: A Framework for Identifying Spectra from 3D Eclipse Mapping''}. %\textit{The Astrophysical Journal}.
                    \item $^{\star}$Guzewich, S. D., \textbf{Lustig-Yaeger, J.}, Davis, C. E., Kopparapu, R. K., Way, M. J., \& Meadows, V. S.  (2019, $^{\star}$\textit{submitted}). \href{}{``The Impact of Planetary Rotation Rate on the Reflectance and Thermal Emission Spectrum of Terrestrial Exoplanets Around Sun-like Stars''}. \textit{The Astrophysical Journal}.
...
\section{List of \\Presentations} 
                {\sl ~~~\underline{Invited Talks}}
                \begin{benumerate}{4}
                    \item $^{\star}$\textbf{Lustig-Yaeger, J.} \& Meadows, V. S.\ (2019, $^{\star}$\textit{upcoming}). 
                    \href{}{``The Era of Terrestrial Exoplanet Characterization''}. AGU, AGU-AAS joint exoplanet session, San Francisco, CA, 10 Dec. 
                    \item $^{\star}$\textbf{Lustig-Yaeger, J.}, Meadows, V. S., \& Lincowski, A. P.\ (2019, $^{\star}$\textit{upcoming}). \href{https://seec.gsfc.nasa.gov/Symposium.html}{``Prospects for Biosignatures for Rocky Planets in the Era of JWST''}. SEEC Symposium 2019, ``Rocky Exoplanets in the Era of JWST: Theory and Observation'', NASA Goddard, Greenbelt, MD, 5 Nov. 
                ...
                \end{benumerate}
                {\sl ~~~\underline{Contributed Talks}}
                \begin{benumerate}{7}
